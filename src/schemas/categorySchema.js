...
export const categorySchema = z.object({
    body: z.object({
        nombre: z
            ...
            .max(70, { message: 'El nombre de la categoria supera la cant. de caracteres permitidos' }),
        descripcion: z
            .string({
                invalid_type_error: 'La descripcion de la categoria solo puede ser texto'
            })
            .max(300, { message: 'La descripcion de la categoria supera la cant. de caracteres permitidos' }),
        estado: z
            .boolean({ 
