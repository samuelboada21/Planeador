...
// @route GET /api/ra
// @access solo Admin
router.get('/', [extractToken, authJWT, isAdmin, validateResultData], raController.getResultados);

// @desc Endpoint encargado de la obtención de un ra por Id
// @route GET /api/ra/:id
// @access solo Admin
router.get('/:id', [extractToken, authJWT, isAdmin, validateResultData], raController.getResultadoById);

// @desc Endpoint encargado de la creación de un ra
// @route POST /api/ra/create
// @access solo Admin
router.post('/create', [extractToken, authJWT, isAdmin, validateResultData], raController.createResultado);

// @desc Endpoint encargado de la actualización de un ra dado su id 
// @route PUT /api/ra/update/:id
// @access solo Admin
router.put('/update/:id', [extractToken, authJWT, isAdmin, validateResultData], raController.updateResultado);

// @desc Endpoint encargado de la eliminacion de un resultado de aprendizaje
// @route PUT /api/ra/deleteRa/:id
// @access solo Admin
router.delete('/deleteRa/:id', [extractToken, authJWT, isAdmin], raController.deleteResultado);
