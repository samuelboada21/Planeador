...
const generateEmail = async (userEmails) => {
  ...
  const response = notification_response();
...
const notification_response = () => {
  return {
    body: {
      ...
      outro:
        "Al ser tu primer ingreso en el sistema, es indispensable que te dirijas al apartado de olvidé mi contraseña e ingreses tu correo institucional, de esta forma enviaremos un token para restablecer la contraseña.",
